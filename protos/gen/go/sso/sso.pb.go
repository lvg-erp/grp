...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       //email to user registration
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // password of user to registration
}
...
type RegisterResponse struct {
	...
	UserId int64 `protobuf:"varint,1,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` //user ID of registration user
}
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x5a, 0x15, 0x76, 0x6c, 0x61, 0x64, 0x69, 0x6d, 0x69, 0x72, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76,
